 ...
 * Synthetic attribute.
 * <p>
 * The length of the synthetic attribute is zero, so this class does nothing,
 * since the attrFactory allocAttr method reads the attribute_name_index and the
 * attribute_length (which, again, is zero).
 * 
 * @author Ian Kaplan
 */
