 ...
 * 
 * 
 * Note that the various access and modifiers are unique except for ACC_SUPER,
 * which seems to be "deprecated" and is used as the ACC_SYNCHRONIZED
 * (synchronized) modifier for methods.
 * 
 */
